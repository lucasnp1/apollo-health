  ...
  return (
    <Reveal delay={delay} className="min-w-0">
      <div className="h-full rounded-xl border border-border bg-card p-3.5 shadow-[var(--shadow-card)] sm:p-4">
        <p className="truncate font-mono text-[11px] uppercase tracking-[0.12em] text-muted-foreground">{label}</p>
        {children}
      </div>
    </Reveal>
  )
        ...
        <MiniStat label="Wellbeing" delay={0.1}>
          {sym.checkIns === 0 ? (
            ...
            <>
              ...
              <p className="mt-0.5 truncate text-xs leading-tight text-muted-foreground">good / watch</p>
            </>
          )}
        </MiniStat>
      </div>
